...
if __name__ == "__main__":
    ...
    cifar10_pick = np.dot(cifar10_pick[...,:3], [0.2989, 0.5870, 0.1140]) #convert to grayscale
    ...
    Parallel(n_jobs=-1, prefer="threads")(delayed(LP_metric)(cifar10_pick[i,:], cifar10_pick[j,:], dist, delta, all_res, i, j, start_time) for i in range(n) for j in range(n))
    end_time = time.time()
