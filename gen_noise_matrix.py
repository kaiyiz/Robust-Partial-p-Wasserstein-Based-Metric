...
for noise_rate in noise_rates:
    ...
    args = ['python', 'gen_OTP_metric_matrix.py', '--noise', str(noise_rate), '--n', str(n), '--delta', str(delta), '--data_name', data_name, '--metric_scaler', str(metric_scaler), '--noise_type', noise_type]
